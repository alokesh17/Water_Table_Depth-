---
title: "noflow_water_table_depth_comparizon"
...
library(dplyr)
Y_77=dat_ws77_2006_2019%>%dplyr::select(c(Depth_cm_b,elev_m_asl,Air_Temp_C,Soil_Temp_,Rainfall,Solar_rad_,net_rad,PET,RH,Windspeed_,Wind_direc,Vapor_Kpa))

Y_78=dat_ws78_2006_2019%>%dplyr::select(c(Depth_cm_b,Elev_m_asl,Air_Temp_C,Soil_Temp,Rainfall_m.x,Solar_rad_,net_rad,PET,RH,Windspeed_,Wind_direc,Vapor_Kpa))

Y_80=dat_ws80_2006_2019%>%dplyr::select(c(Water.Table.Depth.BGS..cm.,Elevation.of.water.table.ASL..m.,Ave_air_T,Soil_Temp_,Rainfall_m,Ave_solar,net_rad,PET,RH,Windspeed_,Wind_direc,Ave_vapor_))
```
```{r}
dim(Y_77)
dim(Y_78)
...
```{r}
Y_80_monthly=dat_ws80_2006_2019%>%dplyr::select(c(Water.Table.Depth.BGS..cm.,Elevation.of.water.table.ASL..m.,Ave_air_T,Soil_Temp_,Rainfall_m,Ave_solar,net_rad,PET,RH,Windspeed_,Wind_direc,Ave_vapor_,month_extracted,year_extracted))%>%drop_na()

monthly_data_ws80_monthlystack=array(rep(0,12*15*14),dim=c(12,15,14))##monthly_data_ws77_monthlystack[,,j] is the matrix for the month month_array[j],last and first 12 months 14 years
...
Y_77=dat_ws77_2006_2019%>%drop_na%>%dplyr::select(c(Depth_cm_b,Air_Temp_C,Soil_Temp_,Rainfall,Solar_rad_,net_rad,PET,RH,Windspeed_,Wind_direc,Vapor_Kpa))
VARX=list()
...
newdat$lower=dat$predicted-3*sd
newdat$upper=dat$predicted+3*sd
...
```{r,fig.width=1.6,fig.height=1.6}
#Y_78=dat_ws78_2006_2019%>%dplyr::select(c(Depth_cm_b,Elev_m_asl,Air_Temp_C,Soil_Temp,Rainfall_m.x,Solar_rad_,net_rad,PET,RH,Windspeed_,Wind_direc,Vapor_Kpa))
Y_78=dat_ws78_2006_2019%>%drop_na()%>%dplyr::select(c(Depth_cm_b,Air_Temp_C,Soil_Temp,Rainfall_m.x,Solar_rad_,net_rad,PET,RH,Windspeed_,Wind_direc,Vapor_Kpa))
...
```{r,fig.width=1.6,fig.height=1.6}
Y_80=dat_ws80_2006_2019%>%drop_na()%>%dplyr::select(c(Water.Table.Depth.BGS..cm.,Ave_air_T,Soil_Temp_,Rainfall_m,Ave_solar,net_rad,PET,RH,Windspeed_,Wind_direc,Ave_vapor_))
VARX=list()
VARX$k=1 # indicates that the first two series are modeled
VARX$m=11
VARX$s=2 # sets 2 as the maximal lag order for exogenous series
...
```{r,fig.width=1.6,fig.height=1.6}
Y_80_monthly=dat_ws80_2006_2019%>%drop_na()%>%dplyr::select(c(Water.Table.Depth.BGS..cm.,Elevation.of.water.table.ASL..m.,Ave_air_T,Soil_Temp_,Rainfall_m,Ave_solar,net_rad,PET,RH,Windspeed_,Wind_direc,Ave_vapor_,month_extracted,year_extracted))
...
```{r,fig.width=1.6,fig.height=1.6}
# Y_80_monthly=dat_ws80_2006_2019%>%dplyr::select(c(Water.Table.Depth.BGS..cm.,Water.Table.Depth.BGS..cm.,Ave_air_T,Soil_Temp_,Rainfall_m,Ave_solar,net_rad,PET,RH,Windspeed_,Wind_direc,Ave_vapor_,month_extracted,year_extracted))

Y_77_monthly=dat_ws77_2006_2019%>%drop_na()%>%dplyr::select(c(Depth_cm_b,elev_m_asl,Air_Temp_C,Soil_Temp_,Rainfall,Solar_rad_,net_rad,PET,RH,Windspeed_,Wind_direc,Vapor_Kpa,month_extracted,year_extracted))
...
monthly_data_ws77_monthlystack=array(rep(0,12*15*14),dim=c(12,15,14))##monthly_data_ws77_monthlystack[,,j] is the matrix for the month month_array[j],last and first 12 months 14 years
...
# Y_77_monthly=dat_ws77_2006_2019%>%dplyr::select(c(Depth_cm_b,elev_m_asl,Air_Temp_C,Soil_Temp_,Rainfall,Avg_FlowRa,Solar_rad_,net_rad,PET,RH,Windspeed_,Wind_direc,Vapor_Kpa,month_extracted,year_extracted))
 ...
 Y_78_monthly=dat_ws78_2006_2019%>%dplyr::select(c(Depth_cm_b,Elev_m_asl,Air_Temp_C,Soil_Temp,Rainfall_m.x,Solar_rad_,net_rad,PET,RH,Windspeed_,Wind_direc,Vapor_Kpa,month_extracted,year_extracted))


monthly_data_ws78_monthlystack=array(rep(0,12*15*14),dim=c(12,15,14))##monthly_data_ws77_monthlystack[,,j] is the matrix for the month month_array[j],last and first 12 months 14 years
...
row.names(COEF)=c("intercept","Y1L1","Y1L2","Y1L3","Y1L4","Air_Temp_C1","Soil_Temp_1","Rainfall1","Solar_rad_1","net_rad1","PET1","RH1","Windspeed_1","Wind_direc1","Vapor_Kpa1","Air_Temp_C2","Soil_Temp_2","Rainfall2","Solar_rad_2","net_rad2","PET2","RH2","Windspeed_2","Wind_direc2","Vapor_Kpa2")
COEF
```
